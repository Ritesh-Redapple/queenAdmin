  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
              ...
              private sanitizer: DomSanitizer
                 ...
                 /* this.form = this.fb.group({
                   ...
                   tournament_rebuy_expiry_time: new FormControl('',[Validators.required]), 
    ...
    if(this.defaults.tournament_days && this.defaults.tournament_schedule_days ==="days"){
     console.log("ok");
      ...
      tournament_entry_fee:[this.defaults.tournament_entry_fee || ''],
       ...
       tournament_betting_time:[this.defaults.tournament_betting_time || ''],

       tournament_add_on_expiry_time:[this.defaults.tournament_add_on_expiry_time || ''],

       tournament_image:[this.defaults.tournament_image || ''],

       tournament_rebuy_expiry_time:[this.defaults.tournament_rebuy_expiry_time || ''],
