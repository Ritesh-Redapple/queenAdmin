...
@Component({
  ...
  templateUrl: './coin-withdraw-update.component.html',
  styleUrls: ['./coin-withdraw-update.component.scss']
})
export class CoinWithdrawUpdateComponent implements OnInit {
  user_name:any;
  phone_code:any;
  selected=false;
  coins:any;
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
              private dialogRef: MatDialogRef<CoinWithdrawUpdateComponent>,
