...
{ label: 'Withdraw Coins', property: 'coin_amount', type: 'text', visible: true },
{ label: 'Reason', property: 'reason', type: 'text', visible: true },

{ label: 'Status', property: 'approval_status', type: 'text', visible: true },
...
this.userService.getAllTransactionDebit().subscribe(users => {
