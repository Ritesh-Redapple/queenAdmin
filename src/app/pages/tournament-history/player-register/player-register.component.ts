...
export class RegisterComponent implements OnInit {
  ...
  ngOnInit() {
  this.tournamentService.getAllPlayersDetails(this.defaults.tournament_id).subscribe(Roles => {
      console.log(Roles);
  ...
  createPlayer() {
    ...
    this.tournamentService.registerPlayer(registerform).subscribe(User => {
