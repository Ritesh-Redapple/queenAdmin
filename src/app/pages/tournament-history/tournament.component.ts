...
roles:[];
 ...
 @Input()
  ...
  { label: 'Tournament Date', property: 'tournament_start_date', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },

   { label: 'Tournament Time', property: 'tournament_start_time', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
   ...
   { label: 'Players Registered', property: 'registerUsers', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
   ...
   { label: 'Inhouse Registrations', property: 'inhouseUser', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },

   { label: 'Ex In house Registrations', property: 'exhouseUser', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
   ...
   { label: 'Total Buy Ins', property: 'total_buy_ins', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },

    { label: 'Total Rebuy', property: 'total_rebuy', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },

    { label: 'Total Add On', property: 'total_add_on', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },


    { label: 'Payout Structure', property: 'tournament_structure', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },

     { label: 'Winners', property: 'winnerCount', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
...
this.tournamentService.getTournamentHistory().subscribe(users => {
...
updateTournament(player: Player,columns) {

console.log("playerrr"+JSON.stringify(columns))
...
registerUser(player: Player,columns) {
console.log("11playerrr"+JSON.stringify(player))


console.log("playerrr"+JSON.stringify(columns))
if(columns==="registerUsers"){
this.dialog.open(RegisterComponent, {
data: player
}).afterClosed().subscribe(updatedPlayer => {
/**
