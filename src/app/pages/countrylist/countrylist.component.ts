...
{ label: 'Image', property: 'country_id', type: 'text', visible: false },
{ label: 'Phone Code', property: 'phone_code', type: 'text', visible: true },
{ label: 'Country Code', property: 'country_code', type: 'text', visible: true },
{ label: 'Country Name', property: 'country_name', type: 'text', visible: true },
{ label: 'Type', property: 'type', type: 'text', visible: false },
{ label: 'Reference', property: 'reference', type: 'text', visible: false },
{ label: 'Balance', property: 'balance', type: 'text', visible: false },
...
this.coinService.getAllCountries().subscribe(users => {
...
createPlayer() {
this.dialog.open(CountryCreateUpdateComponent).afterClosed().subscribe((player: Player) => {
/**
