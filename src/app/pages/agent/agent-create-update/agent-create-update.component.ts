...
export class AgentCreateUpdateComponent implements OnInit {
  user_name:any;
  phone_code:any;
  selected=false;
  status:any;
...
{ name: 'Deleted',value:'deleted' }
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
              private dialogRef: MatDialogRef<AgentCreateUpdateComponent>,
  ...
  ngOnInit() {
   ...
   ////////////////////////////////
    ...
    this.form = this.fb.group({
      ...
      agent_password:[this.defaults.agent_password || 'pokeragent@123'],

      agent_no_of_players:[this.defaults.agent_no_of_players || ''],

      agent_players_rake:[this.defaults.agent_players_rake || ''],

      agent_total_commission:[this.defaults.agent_total_commission || ''],

      agent_commission_paid_out:[this.defaults.agent_commission_paid_out || ''],

      agent_commission_pay_pending:[this.defaults.agent_commission_pay_pending || ''],

      agent_regd_date:[this.defaults.agent_regd_date || ''],
